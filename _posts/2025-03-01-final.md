...
<div class="container">
  ...
  <p> "some text is difficult to read in some backgrounds and add some drop down menus" </p>
...
<p> Investigating computing innovations, evaluate and test algorithims and programs, develop programs that incorperate abstractions, Develop and Implement Algorithms</p>
...
<p>5 things done over the 12 weeks: 4.59/5 I stayed organized through issues and burndown lists but they could have been more thorough and detailed</p>

<p>full stack demo/ Night @ The museum Feedback: 1.5/2 While I was able to get my feature fully working, sometimes it took me longer past the deadline to get my feature functioning</p>
...
<p>List/collection: a list is used to store user messages which allows efficient data abstraction, enabling features like displaying chat history and  updating recommendations based on user input.</p>

<p>Procedure with Parameters: could handle sending messages and organizing chatrooms.</p>
